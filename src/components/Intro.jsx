    ...
    <section className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-6 md:py-12 lg:py-18">
      ...
      <div className="flex w-full items-center justify-center space-x-4 pt-4 ">
        <a
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1  disabled:pointer-events-none disabled:opacity-50 border   shadow-sm hover:bg-gray-100  h-9 px-4 py-2"
          href="#"
        >
